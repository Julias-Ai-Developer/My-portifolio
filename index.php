...
<div class="picman_tm_header">
	<div class="container">
		<div class="inner">
			<div class="logo">
				<a href="index.php"> KAMATRUST AI</a>
			</div>
			<div class="menu">
				<ul class="anchor_nav">
		...
		<div class="container">
			...
			<div class="footer_bottom">
				<div class="copyright wow fadeInUp" data-wow-duration="1s">
					<p>Designed with love by <a href="https://themeforest.net/user/marketify" target="_blank">Marketify</a> &copy; 2022</p>
				</div>
...
<!-- Mirrored from marketifythemes.net/html/picman/index-particle.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 May 2025 19:51:54 GMT -->
</html>